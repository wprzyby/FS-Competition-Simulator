...
bool compare(std::pair<EventsCategories, double> const &first_vector, std::pair<EventsCategories, double> const &second_vector);  // Returns true if variable of the type double is greater in the second vector
