...
const std::vector<EventsCategories> BusPlaEveCat = {pitch_video, novelty, content, finances, deep_dive_topic, demontration_and_structure, delivery, questions, general_impression};
...
const std::vector<EventsCategories> SkiEveCat = {first_left_time, first_right_time, second_left_time, second_right_time, first_ski_penalties, second_ski_penalties, ski_best_time};  //TODO: TODO: Decide what a penalty is!  |  Penalties are summed points of all infrigements (IDK, Should it be a function?)
