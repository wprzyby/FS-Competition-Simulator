...
SRCS := \
	...
	$(TS)/test_acceleration.cpp $(TS)/test_autocross.cpp $(TS)/test_businessplan.cpp $(TS)/test_competition.cpp $(TS)/test_cost_and_manufacturing.cpp $(TS)/test_endurance.cpp $(TS)/test_engineering_design.cpp\
	$(TS)/test_event_functionalities.cpp $(TS)/test_laptimeparser.cpp $(TS)/test_skidpad.cpp $(TS)/catch_config.cpp\
	Event_tools.cpp exceptions.cpp json_config.cpp $(EN)/enums.cpp
