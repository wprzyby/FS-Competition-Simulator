...
std::vector<EventsCategories> SkiEveCat = {first_left_time, first_right_time, second_left_time, second_right_time, first_ski_penalties, second_ski_penalties};  //TODO: TODO: Decide what a penalty is!  |  Penalties are summed points of all infrigements (IDK, Should it be a function?)
