...
const std::map<EventType, EventCategories> EventSimulatorStandard::std_events_categories = {
...
EventCategories EventSimulatorStandard::get_event_categories(EventType event_type) {
